...
<p>
    <a href="{{$pre_url}}co-so/chi-tiet" class="btn btn-primary">Thêm mới</a>
</p>
                ...
                <table id="data_table" class="table table-hover">
                        ...
                        <tbody>
                            ...
                            @foreach ($items as $item)
                                ...
                                <td>{{$item->diachi}}</td>
                                    <td>
                                    <a href="{{$pre_url}}co-so/chi-tiet/{{$item->id}}" data-toggle="tooltip" title="Sửa"><i class="ik ik-edit f-16 mr-15 text-green"></i></a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Xác nhận xóa danh mục Cơ sở?
            </div>
            <div class="modal-footer">
                <form method="POST" action="{{$pre_url}}co-so/xoa">
                    @csrf
